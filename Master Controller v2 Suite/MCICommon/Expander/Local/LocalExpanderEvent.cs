...
namespace MCICommon
{
    ...
    public class ExpanderEvent
    {
        ...
        public ExpanderEvent(DateTime event_datetime, bool[] exp0_mask, bool[] exp1_mask, bool[] exp0_vals, bool[] exp1_vals)
        {
        ...
        public async Task Process(ExpanderMonitor expmon)
        {
            if(DateTime.Now >= event_datetime)
            {
                ...
                await expmon.WriteExpanders(exp0_mask, exp1_mask, exp0_vals, exp1_vals);
